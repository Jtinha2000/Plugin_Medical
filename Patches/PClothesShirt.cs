...
// Type: UMedical.Patches.PClothesShirt
...
{
  [HarmonyPatch(typeof (PlayerClothing), "askWearShirt", new Type[] {typeof (ushort), typeof (byte), typeof (byte[]), typeof (bool)})]
  public static class PClothesShirt
  {
