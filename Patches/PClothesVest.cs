...
// Type: UMedical.Patches.PClothesVest
...
{
  [HarmonyPatch(typeof (PlayerClothing), "askWearVest", new Type[] {typeof (ushort), typeof (byte), typeof (byte[]), typeof (bool)})]
  public static class PClothesVest
  {
