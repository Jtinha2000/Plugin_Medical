...
// Type: UMedical.Patches.PClothesHatW
...
{
  [HarmonyPatch(typeof (PlayerClothing), "askWearHat", new Type[] {typeof (ushort), typeof (byte), typeof (byte[]), typeof (bool)})]
  public static class PClothesHatW
  {
