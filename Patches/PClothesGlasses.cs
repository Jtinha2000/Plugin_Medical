...
// Type: UMedical.Patches.PClothesGlasses
...
{
  [HarmonyPatch(typeof (PlayerClothing), "askWearGlasses", new Type[] {typeof (ushort), typeof (byte), typeof (byte[]), typeof (bool)})]
  public static class PClothesGlasses
  {
