...
// Type: UMedical.Patches.PClothesPants
...
{
  [HarmonyPatch(typeof (PlayerClothing), "askWearPants", new Type[] {typeof (ushort), typeof (byte), typeof (byte[]), typeof (bool)})]
  public static class PClothesPants
  {
