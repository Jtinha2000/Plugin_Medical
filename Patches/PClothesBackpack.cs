...
// Type: UMedical.Patches.PClothesBackpack
...
{
  [HarmonyPatch(typeof (PlayerClothing), "askWearBackpack", new Type[] {typeof (ItemBackpackAsset), typeof (byte), typeof (byte[]), typeof (bool)})]
  public static class PClothesBackpack
  {
