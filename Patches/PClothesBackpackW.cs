...
// Type: UMedical.Patches.PClothesBackpackW
...
{
  [HarmonyPatch(typeof (PlayerClothing), "askWearBackpack", new Type[] {typeof (ushort), typeof (byte), typeof (byte[]), typeof (bool)})]
  public static class PClothesBackpackW
  {
