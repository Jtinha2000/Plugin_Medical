...
// Type: UMedical.Patches.PClothesShirtW
...
{
  [HarmonyPatch(typeof (PlayerClothing), "askWearShirt", new Type[] {typeof (ItemShirtAsset), typeof (byte), typeof (byte[]), typeof (bool)})]
  public static class PClothesShirtW
  {
